...
public enum GuiText {
	...
	SELECTOR_RAIL_BED_FILL_WIDTH("selector.rail_bed_fill_width"),
	SELECTOR_EMBANKMENT("selector.embankment"),
	SELECTOR_EMBANKMENT_OFFSET("selector.embankment_offset"),
	SELECTOR_EMBANKMENT_HEIGHT("selector.embankment_height"),
	SELECTOR_EMBANKMENT_GRADIENT("selector.embankment_gradient"),
	SELECTOR_CUTTING("selector.cutting"),
	SELECTOR_CUTTING_OFFSET("selector.cutting_offset"),
	SELECTOR_CUTTING_HEIGHT("selector.cutting_height"),
	SELECTOR_CUTTING_GRADIENT("selector.cutting_gradient"),
	...
	TRACK_RAIL_BED_FILL_WIDTH("track.rail_bed_fill_width"),
	TRACK_EMBANKMENT("track.embankment"),
	TRACK_EMBANKMENT_OFFSET("track.embankment_offset"),
	TRACK_EMBANKMENT_HEIGHT("track.embankment_height"),
	TRACK_EMBANKMENT_GRADIENT("track.embankment_gradient"),
	TRACK_CUTTING("track.cutting"),
	TRACK_CUTTING_OFFSET("track.cutting_offset"),
	TRACK_CUTTING_HEIGHT("track.cutting_height"),
	TRACK_CUTTING_GRADIENT("track.cutting_gradient"),
